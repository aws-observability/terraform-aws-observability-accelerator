...
#--------------------------------------------------------------
# CloudWatch Logs Datasource (cloudwatch-otlp profile)
#--------------------------------------------------------------
...
#--------------------------------------------------------------
# X-Ray Plugin Installation (cloudwatch-otlp profile)
#--------------------------------------------------------------
  ...
  provisioner "local-exec" {
    ...
    command     = <<-EOT
      curl -s -X POST \
        ...
        "$GRAFANA_URL/api/plugins/grafana-x-ray-datasource/install" -d '{}'
    EOT
    environment = {
...
#--------------------------------------------------------------
# X-Ray Datasource (cloudwatch-otlp profile)
#--------------------------------------------------------------
