...
**Tools:** Ensure that you have the following tools installed locally.
...
**EKS Cluster:**  To run this example, you need to provide your EKS cluster name or if you don't have a cluster ready, first to create a new one, visit [this example](../eks-cluster-with-vpc).
