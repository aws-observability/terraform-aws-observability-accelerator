...
| <a name="input_opensearch_config"></a> [opensearch\_config](#input\_opensearch\_config) | Config object for API server monitoring | <pre>object({<br>    flux_gitrepository_name   = string<br>    flux_gitrepository_url    = string<br>    flux_gitrepository_branch = string<br>    flux_kustomization_name   = string<br>    flux_kustomization_path   = string<br><br>    dashboards = object({<br>      logs = string<br>    })<br>  })</pre> | `null` | no |
...
| <a name="input_os_logs_region"></a> [os\_logs\_region](#input\_os\_logs\_region) | OpenSearch Domain Region | `string` | `null` | no |
